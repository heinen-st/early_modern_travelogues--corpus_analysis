...
source_hainhofer = os.path.join(data_dir, 'korpus_hainhofer.csv')
...
path_small = os.path.join(data_dir, 'stopwords_hainhofer_small.json')
with open(path_small, 'w') as outfile:
    outfile.write(json.dumps(stop_words_hainhofer_small))

path_large = os.path.join(data_dir, 'stopwords_hainhofer_large.json')
